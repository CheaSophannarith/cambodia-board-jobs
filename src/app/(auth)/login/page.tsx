        ...
        <Tabs defaultValue="account" className="w-[500px]">
          ...
          <TabsContent value="account" className="space-y-6">
            ...
            <div className="flex gap-4">
              <button className="flex-1 flex items-center justify-center gap-2 border border-notice py-3 hover:bg-gray-50">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-[#f1f2f2] px-2">Or login with email</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <button className="w-full bg-notice text-white py-3 text-lg font-semibold hover:bg-notice/90">
                Continue
              </button>
            </div>
          ...
          <TabsContent value="password" className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#f1f2f2]">Or login with email</span>
              </div>
            </div>
